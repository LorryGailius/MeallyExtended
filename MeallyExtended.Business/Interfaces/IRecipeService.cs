...
namespace MeallyExtended.Business.Interfaces
{
    public interface IRecipeService
    {
        ...
        Task<PaginationResult<RecipeDto>> GetRecipesByQuery(string? query, List<string>? categories, string userEmail, int pageNo, int pageSize);
        Task<Recipe> UpdateRecipe(UpdateRecipeRequest recipe, string userEmail);
        Task<PaginationResult<RecipeDto>> GetBrowseRecipes(string userEmail, int pageNo, int pageSize);
